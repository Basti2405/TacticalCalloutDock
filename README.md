...
**Taktische Ansagen für Mythic+ und Raids – ein Klick statt einer getippten
Zeile mitten im Pull.**

Im Key ist die Ansage oft wichtiger als die Rotation: *„Warten, Patrouille“*,
*„LoS-Pull um die Ecke“*, *„Brauche Mana“*. Nur hat man beim Tippen beide Hände
am Charakter – und wenn die Zeile endlich dasteht, ist der Pull gelaufen.
...
**Drei Rollenprofile, fertig bestückt.** Tank, Heiler und DPS mit je acht
Ansagen aus dem echten Key-Alltag – von *„Pack wird geskippt – Shroud jetzt“*
bis *„Unterbrecher stehen – ich kicke zuerst“*. Umschalten über die Reiter an
der Leiste oder `/tcd tank`.
...
**Der Kanal stimmt von selbst.** Dieselbe Taste geht im Key in den Instanzchat,
im Raid in den Raidchat und allein in `/sagen`.
...
**Platzhalter.** `%t` Ziel, `%f` Fokus, `%m` Mouseover, `%p` du selbst. Gibt es
das Ziel nicht, steht dort *„kein Ziel“* statt einer Lücke.
...
Andere Aktionsleisten melden mitten im Pull *„geht erst nach dem Kampf“*. Der
Grund: Sobald ein Knopf eine Fähigkeit wirken kann, braucht er ein Secure
Template, und das darf im Kampf nicht angefasst werden.
...
Direkt an der Leiste: **Shift-Klick** oder **Rechtsklick** auf einen Knopf
...
- **Markieren geht nur mit dem Recht dazu.** In einer Pug ohne Lead oder
  Assist setzt `SetRaidTarget` nichts. Das Addon prüft das vorher und sagt es
  einmal – die Chatnachricht geht trotzdem raus.
...
- **Keine Broker-Anbindung.** Titan Panel und ChocolateBar finden dieses Addon
  nicht – dafür bräuchte es LibDataBroker, und das Addon kommt bewusst ohne
  jede Fremdbibliothek aus.
