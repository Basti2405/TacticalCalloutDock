...
L.MSG_NO_MARK_RIGHT    = "Zum Markieren brauchst du in der Gruppe Lead oder Assist."
...
L.CFG_MARKER_TIP   = "Wird auf dein aktuelles Ziel gesetzt. In der Gruppe brauchst du dafür Lead oder Assist."
L.CFG_PING         = "Ping"
L.CFG_PING_TIP     = "Benutzt das Ping-Rad des Spiels. Löst nur bei einem echten Mausklick aus, nie von selbst."
L.CFG_PLACEHOLDERS = "Platzhalter: %t Ziel, %f Fokus, %m Mouseover, %p du selbst"
...
L.CFG_THROTTLE     = "Wiederholungssperre (Sekunden)"
L.CFG_THROTTLE_TIP = "Verhindert, dass derselbe Knopf zweimal kurz hintereinander feuert - sonst greift der Spamschutz des Servers."
...
L.TIP_SHIFT      = "Shift-Klick: diesen Knopf bearbeiten"
...
L.SUB_NO_MOUSEOVER = "kein Mouseover"
...
-- Tank ----------------------------------------------------------------------
L.LBL_T_LOS       = "LoS"
L.SAY_T_LOS       = "Ziehe um die Ecke – LoS-Pull, bleibt hinter mir"
L.LBL_T_PATROL    = "Pat"
L.SAY_T_PATROL    = "Warten, Patrouille kommt"
L.LBL_T_SKIP      = "Skip"
L.SAY_T_SKIP      = "Pack wird geskippt – Shroud jetzt"
L.LBL_T_GATHER    = "Warte"
L.SAY_T_GATHER    = "Ich sammle noch – bitte noch nicht pullen"
L.LBL_T_BIGPULL   = "Groß"
L.SAY_T_BIGPULL   = "Großer Pull – Cooldowns bitte"
L.LBL_T_SKULL     = "Schädel"
L.SAY_T_SKULL     = "Fokus Totenschädel %t"
L.LBL_T_KITE      = "Kite"
L.SAY_T_KITE      = "Ich kite den – bitte nicht taunten"
L.LBL_T_EXTERNAL  = "Hilfe"
L.SAY_T_EXTERNAL  = "Bin low – External bitte"
...
L.LBL_H_DEFS      = "Defs"
L.SAY_H_DEFS      = "Defensives jetzt – gleich kommt schwerer Schaden"
L.LBL_H_DISPEL    = "Disp"
L.SAY_H_DISPEL    = "Ich dispelle – bitte auseinander"
L.LBL_H_REZ       = "Rez"
...
L.LBL_H_LUST      = "Lust"
L.SAY_H_LUST      = "Bloodlust bei diesem Pull"
...
L.LBL_D_CC        = "CC"
L.SAY_D_CC        = "Mond ist im CC – bitte nicht brechen"
L.LBL_D_CDS       = "CDs"
...
L.LBL_D_HOLD      = "Halt"
L.SAY_D_HOLD      = "Meine Cooldowns sind noch nicht bereit – kurz halten"
