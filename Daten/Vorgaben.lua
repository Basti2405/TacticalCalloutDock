...
V.HEALER = {
    ...
    { lbl = "LBL_H_REZ",    say = "SAY_H_REZ",    symbol = "Interface\\Icons\\Spell_Holy_Resurrection", ping = "ASSIST" },
...
V.DAMAGER = {
    ...
    { lbl = "LBL_D_OMW",   say = "SAY_D_OMW",   symbol = "Interface\\Icons\\Ability_Hunter_Pathfinding", ping = "ONMYWAY" },
